...
category1 = category_coment1[(category_coment1['review_type'] == 'Product')                             | (category_coment1['review_type'] == 'Package')                             |(category_coment1['review_type'] == 'Function')]
category2 = category1.groupby(['category','brand', 'is_competitor', 'emotion'],                                    as_index=False)['comments#'].sum()
# pg positive% brand level
